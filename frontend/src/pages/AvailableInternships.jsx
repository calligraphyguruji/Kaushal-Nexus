    ...
    <PageTransition className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-sky-200 bg-gradient-to-br from-sky-50/80 via-white to-indigo-50/40 p-6 sm:p-7 shadow-xs dark:border-sky-900/50 dark:from-slate-900 dark:via-slate-900/90 dark:to-sky-950/30">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-2.5">
            <div className="inline-flex items-center gap-2 rounded-full border border-sky-300 bg-sky-100/90 px-3.5 py-1 text-xs font-semibold text-sky-800 dark:border-sky-800 dark:bg-sky-950/70 dark:text-sky-300">
            ...
            <p className="max-w-2xl text-xs sm:text-sm leading-relaxed text-slate-600 dark:text-slate-300">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 lg:flex lg:items-center">
            <div className="rounded-xl border border-slate-200/80 bg-white/90 p-3.5 text-center shadow-2xs dark:border-slate-800 dark:bg-slate-800/80 min-w-[110px]">
              <span className="text-xs font-mono font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">
                Matched Roles
              </span>
              <div className="mt-1 text-2xl sm:text-3xl font-extrabold text-sky-600 dark:text-sky-400">
                {metrics.total}
              </div>
              <span className="text-xs text-slate-500 dark:text-slate-400">Live Vacancies</span>
            </div>

            <div className="rounded-xl border border-emerald-200/80 bg-emerald-50/60 p-3.5 text-center shadow-2xs dark:border-emerald-900/60 dark:bg-emerald-950/40 min-w-[115px]">
              <span className="text-xs font-mono font-bold uppercase tracking-wider text-emerald-700 dark:text-emerald-400">
                High Match (80%+)
              </span>
              <div className="mt-1 text-2xl sm:text-3xl font-extrabold text-emerald-700 dark:text-emerald-300">
                {metrics.highMatches}
              </div>
              <span className="text-xs text-emerald-700 dark:text-emerald-400 font-medium">Ready to Apply</span>
            </div>

            <div className="rounded-xl border border-slate-200/80 bg-white/90 p-3.5 text-center shadow-2xs dark:border-slate-800 dark:bg-slate-800/80 min-w-[115px]">
              <span className="text-xs font-mono font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">
                Avg. Stipend
              </span>
              <div className="mt-1 text-2xl sm:text-3xl font-extrabold text-indigo-600 dark:text-indigo-400">
            ...
            <div className="rounded-xl border border-slate-200/80 bg-white/90 p-3.5 text-center shadow-2xs dark:border-slate-800 dark:bg-slate-800/80 min-w-[110px]">
              ...
              <div className="mt-1 text-2xl sm:text-3xl font-extrabold text-violet-600 dark:text-violet-400">
                {applications.length}
              </div>
        ...
        <div className="mt-5 flex flex-wrap items-center justify-between gap-3 border-t border-slate-200/70 pt-4 text-xs sm:text-sm text-slate-600 dark:border-slate-800 dark:text-slate-300">
          <div className="flex items-center gap-2">
            <GraduationCap size={16} className="text-sky-600 dark:text-sky-400 shrink-0" />
            <span>
            ...
            <span className="rounded bg-sky-100 px-2 py-0.5 text-xs font-mono font-bold text-sky-700 dark:bg-sky-950 dark:text-sky-300">
      ...
      <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800">
        <div className="flex gap-6">
          <button
            ...
            className={`flex items-center gap-2 border-b-2 pb-3.5 text-sm font-bold transition-all cursor-pointer ${
              activeTab === "directory"
      ...
      {activeTab === "directory" ? (
        <>
              ...
              {INTERNSHIP_DOMAINS.map((domain) => {
                ...
                return (
                  <button
                    ...
                    className={`group relative flex items-center gap-2 rounded-xl border px-4 py-2.5 text-xs sm:text-sm font-semibold transition-all cursor-pointer ${
                      isSelected
            ...
            <div className="grid grid-cols-1 gap-3.5 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="h-11 w-full rounded-xl border border-slate-200 bg-slate-50/50 py-2.5 pl-10 pr-3.5 text-xs sm:text-sm text-slate-900 placeholder-slate-400 transition focus:border-sky-500 focus:bg-white focus:outline-hidden dark:border-slate-800 dark:bg-slate-800/50 dark:text-white dark:focus:border-sky-400"
                />
                {searchQuery && (
                  <button
                    type="button"
              ...
              <div>
                <select
                  ...
                  className="h-11 w-full rounded-xl border border-slate-200 bg-slate-50/50 py-2 px-3.5 text-xs sm:text-sm text-slate-700 transition focus:border-sky-500 focus:bg-white focus:outline-hidden dark:border-slate-800 dark:bg-slate-800/50 dark:text-slate-200 cursor-pointer"
                >
          ...
          {/* 5. INTERNSHIP CARDS GRID — EXACTLY 2 PER ROW ON DESKTOP */}
          {loading ? (
                      ...
                      <div className="space-y-3.5">
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div className="flex items-center gap-3.5">
                            ...
                            <div>
                              ...
                              <div className="mt-0.5 flex items-center gap-1.5 text-xs text-slate-500">
                                ...
                                <span className="truncate max-w-[180px]">{internship.location}</span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="text-right shrink-0">
                            <AnimatedBadge
                              className={`rounded-full px-3 py-1 text-xs sm:text-sm font-extrabold gap-1.5 ${
                                matchScore >= 80
                        ...
                        <div className="flex flex-wrap items-center gap-2 text-xs font-medium text-slate-600 dark:text-slate-400">
                          <span className="rounded-lg bg-slate-100 px-2.5 py-1 dark:bg-slate-800 font-mono font-semibold text-slate-800 dark:text-slate-200">
                          ...
                          <span className="rounded-lg bg-indigo-50 px-2.5 py-1 font-mono font-semibold text-indigo-700 dark:bg-indigo-950/60 dark:text-indigo-300">
        ...
        <div className="space-y-4">
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xs dark:border-slate-800 dark:bg-slate-900">
            ...
            {applications.length === 0 ? (
              <div className="mt-6 flex flex-col items-center justify-center p-8 text-center text-xs sm:text-sm text-slate-400">
                <FileCheck size={36} className="mb-2.5 text-slate-300 dark:text-slate-600" />
                <p>You have not submitted applications yet.</p>
                <button
                  type="button"
                  onClick={() => setActiveTab("directory")}
                  className="mt-3 text-xs sm:text-sm font-bold text-sky-600 hover:underline dark:text-sky-400 cursor-pointer"
                >
                  ...
                  <div key={idx} className="flex flex-col gap-3 py-4 first:pt-0 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                      ...
                      <div className="mt-1.5 flex items-center gap-3 text-xs text-slate-400">
                        <span className="font-mono">Ref: {app.application_id}</span>
                        <span>•</span>
                    ...
                    <div className="flex items-center gap-3">
                      <span className="inline-flex items-center gap-1.5 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-bold text-emerald-800 dark:border-emerald-900 dark:bg-emerald-950 dark:text-emerald-300">
                      ...
                      <Link
                        ...
                        className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 px-3.5 py-1.5 text-xs sm:text-sm font-semibold text-slate-700 hover:bg-slate-100 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800 transition-colors"
                      >
                        <span>View Role</span>
                        <ArrowRight size={13} />
                      </Link>
